...
mIoU---larger than any single decoder swap ($\le +1.0$);
...
cost. The best configuration (DeepLabV3+-R50 with Combined loss) attains
$0.7332$ test mIoU on full-resolution reconstructions, exceeding the
Vanilla U-Net baseline by $+9.3$ pp. Code and trained weights:
