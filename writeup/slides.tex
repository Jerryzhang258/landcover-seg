...
\begin{frame}{Take-home messages}
  \begin{enumerate}
    ...
    \item \textbf{Deeper $\neq$ Pareto-optimal}: ResNet101 trails R50
          on val ($-0.008$) and edges it on test ($+0.022$)---both within
          single-seed noise---while using $71\%$ more parameters and
          $2.4\times$ training time. \\
...
\begin{frame}{References}
  ...
  \begin{enumerate}
    ...
    \item Demir et al. DeepGlobe 2018: A challenge to parse the earth through satellite images. \emph{CVPR Workshops}, 2018.
    \item Ronneberger, Fischer, Brox. U-Net: Convolutional networks for biomedical image segmentation. \emph{MICCAI}, 2015.
    \item Chen et al. Encoder--decoder with atrous separable convolution for semantic image segmentation (DeepLabV3+). \emph{ECCV}, 2018.
    \item He et al. Deep residual learning for image recognition (ResNet). \emph{CVPR}, 2016.
    \item Roy, Navab, Wachinger. Concurrent spatial and channel squeeze-and-excitation in fully convolutional networks (SCSE). \emph{MICCAI}, 2018.
    \item Milletari, Navab, Ahmadi. V-Net and Dice loss for volumetric medical image segmentation. \emph{3DV}, 2016.
    \item Lin et al. Focal loss for dense object detection. \emph{ICCV}, 2017.
    \item Iakubovskii. \emph{Segmentation Models PyTorch}. \url{github.com/qubvel/segmentation_models.pytorch}, 2019.
    \item Jadon. A survey of loss functions for semantic segmentation. \emph{IEEE CIBCB}, 2020.
  \end{enumerate}
\end{frame}
